...
export const Ukol2 = () => {
  const [jmeno, onSelectName] = useState('Jirka');
  ...
  return (
    <>
      ...
      <div className="button-group">
        <IconButton label="Jirka" onSelectName={onSelectName} />
        <IconButton label="Honza" onSelectName={onSelectName} />
        <IconButton label="Tomáš" onSelectName={onSelectName} />
        <IconButton label="Šimon" onSelectName={onSelectName} />
      </div>
    </>
  );
};
